...
public:
  ...
  auto dot(const Vector3D &other) const -> T;
...
template <typename T>
  requires std::is_floating_point_v<T>
auto Vector3D<T>::operator=(const Vector3D &other) -> Vector3D<T> & {
  x = other.x;
  y = other.y;
  z = other.z;
  return *this;
...
template <typename T>
  requires std::is_floating_point_v<T>
[[nodiscard]] auto Vector3D<T>::operator+(const Vector3D &other) const
    -> Vector3D<T> {
...
template <typename T>
  requires std::is_floating_point_v<T>
auto Vector3D<T>::operator==(const Vector3D &other) const -> bool {
...
template <typename T>
  requires std::is_floating_point_v<T>
[[nodiscard]] auto Vector3D<T>::dot(const Vector3D &other) const -> T {
  return x * other.x + y * other.y + z * other.z;
}
...
template <typename T>
  requires std::is_floating_point_v<T>
[[nodiscard]] auto Vector3D<T>::cross(const Vector3D &other) const
    -> Vector3D<T> {
